...
1. **Login to your AFMS account**
   - URL: https://roadmap-navigator-3.preview.emergentagent.com
...
# Create gateway
curl -X POST https://roadmap-navigator-3.preview.emergentagent.com/api/integrations/payment/gateways \
