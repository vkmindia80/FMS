...
1. **Login to your AFMS account**
   - URL: https://demo-sidebar-issue.preview.emergentagent.com
...
# Create gateway
curl -X POST https://demo-sidebar-issue.preview.emergentagent.com/api/integrations/payment/gateways \
