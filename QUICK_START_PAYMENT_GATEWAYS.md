...
1. **Login to your AFMS account**
   - URL: https://project-planner-24.preview.emergentagent.com
...
# Create gateway
curl -X POST https://project-planner-24.preview.emergentagent.com/api/integrations/payment/gateways \
