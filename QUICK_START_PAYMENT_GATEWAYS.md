...
1. **Login to your AFMS account**
   - URL: https://balance-report-fix.preview.emergentagent.com
...
# Create gateway
curl -X POST https://balance-report-fix.preview.emergentagent.com/api/integrations/payment/gateways \
