...
1. **Login to your AFMS account**
   - URL: https://user-admin-manager.preview.emergentagent.com
...
# Create gateway
curl -X POST https://user-admin-manager.preview.emergentagent.com/api/integrations/payment/gateways \
