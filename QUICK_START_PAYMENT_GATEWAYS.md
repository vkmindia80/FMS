...
1. **Login to your AFMS account**
   - URL: https://reconcile-demo-data.preview.emergentagent.com
...
# Create gateway
curl -X POST https://reconcile-demo-data.preview.emergentagent.com/api/integrations/payment/gateways \
