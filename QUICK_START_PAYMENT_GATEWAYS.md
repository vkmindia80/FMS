...
1. **Login to your AFMS account**
   - URL: https://admin-components-1.preview.emergentagent.com
...
# Create gateway
curl -X POST https://admin-components-1.preview.emergentagent.com/api/integrations/payment/gateways \
