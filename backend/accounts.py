...
def get_account_number_prefix(account_type: AccountType) -> str:
    """Get the appropriate account number prefix based on account type"""
    account_type_mapping = {
        # Assets (1000-1999)
        AccountType.CASH: "1000",
        AccountType.CHECKING: "1010",
        AccountType.SAVINGS: "1020",
        AccountType.ACCOUNTS_RECEIVABLE: "1200",
        AccountType.INVENTORY: "1300",
        AccountType.PREPAID_EXPENSES: "1400",
        AccountType.FIXED_ASSETS: "1500",
        AccountType.EQUIPMENT: "1510",
        AccountType.CURRENT_ASSET: "1600",
        AccountType.OTHER_ASSETS: "1900",
        # Liabilities (2000-2999)
        AccountType.ACCOUNTS_PAYABLE: "2000",
        AccountType.CREDIT_CARD: "2100",
        AccountType.SHORT_TERM_DEBT: "2200",
        AccountType.ACCRUED_EXPENSES: "2300",
        AccountType.LONG_TERM_DEBT: "2500",
        AccountType.LONG_TERM_LIABILITY: "2600",
        AccountType.OTHER_LIABILITIES: "2900",
        # Equity (3000-3999)
        AccountType.OWNER_EQUITY: "3000",
        AccountType.COMMON_STOCK: "3100",
        AccountType.RETAINED_EARNINGS: "3200",
        # Income (4000-4999)
        AccountType.REVENUE: "4000",
        AccountType.SERVICE_INCOME: "4100",
        AccountType.INTEREST_INCOME: "4200",
        AccountType.OTHER_INCOME: "4900",
        # Cost of Goods Sold (5000-5999)
        AccountType.COST_OF_GOODS_SOLD: "5000",
        # Expenses (6000-6999)
        AccountType.OPERATING_EXPENSES: "6000",
        AccountType.OFFICE_SUPPLIES: "6100",
        AccountType.RENT: "6200",
        AccountType.UTILITIES: "6300",
        AccountType.INSURANCE: "6400",
        AccountType.TRAVEL: "6500",
        AccountType.MARKETING: "6600",
        AccountType.SOFTWARE: "6700",
        AccountType.PAYROLL: "6800",
        AccountType.ADMINISTRATIVE_EXPENSES: "6900",
        AccountType.PROFESSIONAL_FEES: "6910",
        AccountType.LEGAL_FEES: "6920",
        AccountType.INTEREST_EXPENSE: "7000",
        AccountType.TAX_EXPENSE: "7100",
        AccountType.OTHER_EXPENSES: "7900",
    }
    return account_type_mapping.get(account_type, "9000")

async def generate_unique_account_number(company_id: str, account_type: AccountType) -> str:
    """Generate a unique account number for an account"""
    base_number = get_account_number_prefix(account_type)
