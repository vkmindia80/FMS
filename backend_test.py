...
class AFMSBackendTester:
    def __init__(self, base_url="https://roadmap-navigator-2.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://roadmap-navigator-2.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://roadmap-navigator-2.preview.emergentagent.com")
