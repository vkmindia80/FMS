...
class AFMSBackendTester:
    def __init__(self, base_url="https://datasprucer.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://datasprucer.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://datasprucer.preview.emergentagent.com")
