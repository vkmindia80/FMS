...
class AFMSBackendTester:
    def __init__(self, base_url="https://multi-arch-check.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://multi-arch-check.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://multi-arch-check.preview.emergentagent.com")
