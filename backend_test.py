...
class AFMSBackendTester:
    def __init__(self, base_url="https://admin-components-1.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://admin-components-1.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://admin-components-1.preview.emergentagent.com")
