...
class AFMSBackendTester:
    def __init__(self, base_url="https://admin-tenant-dash.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://admin-tenant-dash.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://admin-tenant-dash.preview.emergentagent.com")
