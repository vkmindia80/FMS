...
class AFMSBackendTester:
    def __init__(self, base_url="https://datagen-dashboard.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://datagen-dashboard.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://datagen-dashboard.preview.emergentagent.com")
