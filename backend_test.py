...
class AFMSBackendTester:
    def __init__(self, base_url="https://error-fixer-38.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://error-fixer-38.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://error-fixer-38.preview.emergentagent.com")
