...
class AFMSBackendTester:
    def __init__(self, base_url="https://demo-sidebar-issue.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://demo-sidebar-issue.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://demo-sidebar-issue.preview.emergentagent.com")
