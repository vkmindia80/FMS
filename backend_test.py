...
class AFMSBackendTester:
    def __init__(self, base_url="https://reconcile-demo-data.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://reconcile-demo-data.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://reconcile-demo-data.preview.emergentagent.com")
