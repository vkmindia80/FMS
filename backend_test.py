...
class AFMSBackendTester:
    def __init__(self, base_url="https://login-repair-57.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://login-repair-57.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://login-repair-57.preview.emergentagent.com")
