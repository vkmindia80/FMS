...
class AFMSBackendTester:
    def __init__(self, base_url="https://viewfix.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://viewfix.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://viewfix.preview.emergentagent.com")
