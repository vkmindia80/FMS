...
class AFMSBackendTester:
    def __init__(self, base_url="https://roadmap-analysis-3.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://roadmap-analysis-3.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://roadmap-analysis-3.preview.emergentagent.com")
