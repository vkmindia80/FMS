...
class AFMSBackendTester:
    def __init__(self, base_url="https://autofill-repair.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://autofill-repair.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://autofill-repair.preview.emergentagent.com")
