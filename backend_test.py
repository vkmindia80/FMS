...
class AFMSBackendTester:
    def __init__(self, base_url="https://dev-orchestrator.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://dev-orchestrator.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://dev-orchestrator.preview.emergentagent.com")
