...
class AFMSBackendTester:
    def __init__(self, base_url="https://email-config-2.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://email-config-2.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://email-config-2.preview.emergentagent.com")
