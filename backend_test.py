...
class AFMSBackendTester:
    def __init__(self, base_url="https://balance-report-fix.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://balance-report-fix.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://balance-report-fix.preview.emergentagent.com")
