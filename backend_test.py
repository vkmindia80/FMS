...
class AFMSBackendTester:
    def __init__(self, base_url="https://view-not-json.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://view-not-json.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://view-not-json.preview.emergentagent.com")
