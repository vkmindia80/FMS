...
class AFMSBackendTester:
    def __init__(self, base_url="https://cashflow-align.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://cashflow-align.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://cashflow-align.preview.emergentagent.com")
