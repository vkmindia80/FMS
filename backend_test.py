...
class AFMSBackendTester:
    def __init__(self, base_url="https://code-connect-12.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://code-connect-12.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://code-connect-12.preview.emergentagent.com")
