...
class AFMSBackendTester:
    def __init__(self, base_url="https://payglobal-2.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://payglobal-2.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://payglobal-2.preview.emergentagent.com")
