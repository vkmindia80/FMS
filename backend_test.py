...
class AFMSBackendTester:
    def __init__(self, base_url="https://banking-connect-1.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://banking-connect-1.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://banking-connect-1.preview.emergentagent.com")
