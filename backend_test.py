...
class AFMSBackendTester:
    def __init__(self, base_url="https://project-planner-24.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://project-planner-24.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://project-planner-24.preview.emergentagent.com")
