...
class AFMSBackendTester:
    def __init__(self, base_url="https://prefs-upgrade.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://prefs-upgrade.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://prefs-upgrade.preview.emergentagent.com")
