...
class AFMSBackendTester:
    def __init__(self, base_url="https://accounting-fix-3.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://accounting-fix-3.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://accounting-fix-3.preview.emergentagent.com")
