...
class AFMSBackendTester:
    def __init__(self, base_url="https://git-bridge-2.preview.emergentagent.com"):
...
def main():
    ...
    print("Using public endpoint: https://git-bridge-2.preview.emergentagent.com")
    
    tester = AFMSBackendTester("https://git-bridge-2.preview.emergentagent.com")
